...
- The subscription's status in the transactions list will be updated even when the subscription is not connected to a member account (useful for orphaned subscriptions).
