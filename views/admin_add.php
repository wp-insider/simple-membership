...
<table class="form-table">
	...
	<tr class="form-required">
		...
		<td><input class="regular-text validate[required,custom[onlyLetterNumberUnderscore],minSize[4],ajax[ajaxUserCall]]" name="user_name" type="text" id="user_name" value="<?php echo esc_attr($user_name); ?>" aria-required="true" /></td>
	</tr>
	<tr class="form-required">
