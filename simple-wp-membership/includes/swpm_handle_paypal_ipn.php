...
include_once('swpm_handle_subsc_ipn_stand_alone.php');
   	...
   	function swpm_validate_and_create_membership()
	{
			...
			$subsc_ref = $customvariables['subsc_ref'];
    			    ...
    			    if (!empty($subsc_ref))
    			    {
                                if (function_exists('wp_eMember_install'))
                                {
                                    ...
                                    swpm_handle_subsc_signup_stand_alone($this->ipn_data,$subsc_ref,$this->ipn_data['subscr_id'],$eMember_id);
                                }
		...
		foreach ($cart_items as $current_cart_item)
		{
		    ...
		    if (!empty($subsc_ref))
		    {
		    	...
		    	{
					$this->debug_log('eMember integration is being used... creating member account... see the "subscription_handle_debug.log" file for details',true);
					swpm_handle_subsc_signup_stand_alone($this->ipn_data,$subsc_ref,$this->ipn_data['txn_id'],$eMember_id);
		    	}
...
//TODO - get the settings from this plugin
