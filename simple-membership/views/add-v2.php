...
<div class="swpm-registration-widget-form">
    <form id="swpm-registration-form" class="swpm-validate-form" name="swpm-registration-form" method="post" action="<?php echo $current_url;?>">
...
<!-- <script>
    const form = document.getElementById('swpm-registration-form');
