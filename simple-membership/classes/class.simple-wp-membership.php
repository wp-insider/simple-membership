...
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'swpm-compat.php' );
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-utils-misc.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-utils.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-utils-member.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-utils-membership-level.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-utils-template.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-init-time-tasks.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-wp-loaded-tasks.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-self-action-handler.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-comment-form-related.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-settings.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-protection.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-permission.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-auth.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-access-control.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-form.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-transfer.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-front-form.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-level-form.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-membership-levels.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-log.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-messages.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-ajax.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-registration.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-front-registration.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-admin-registration.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-membership-level.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-membership-level-custom.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-permission-collection.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-auth-permission-collection.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-transactions.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'shortcode-related/class.swpm-shortcodes-handler.php');
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-utils-subscription.php');
...
include_once( SIMPLE_WP_MEMBERSHIP_PATH . 'class.swpm-members-meta.php');
