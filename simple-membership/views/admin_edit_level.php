...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
                <p><input type="radio" <?= checked(BMembershipLevel::NO_EXPIRY,$subscription_duration_type,false)?> value="<?= BMembershipLevel::NO_EXPIRY?>" name="subscription_duration_type" /> No Expiry or Until Canceled.</p>                                
                <p><input type="radio" <?= checked(BMembershipLevel::DAYS,$subscription_duration_type,false)?> value="<?= BMembershipLevel::DAYS ?>" name="subscription_duration_type" /> Expire After 
                    <input type="text" value="<?= checked(BMembershipLevel::DAYS,$subscription_duration_type,false)? $subscription_period: "";?>" name="subscription_period_<?= BMembershipLevel::DAYS ?>"> Days.</p>
                ...
                <p><input type="radio" <?= checked(BMembershipLevel::WEEKS,$subscription_duration_type,false)?> value="<?= BMembershipLevel::WEEKS?>" name="subscription_duration_type" /> Expire After 
                    <input type="text" value="<?= checked(BMembershipLevel::WEEKS,$subscription_duration_type,false)? $subscription_period: "";?>" name="subscription_period_<?= BMembershipLevel::WEEKS ?>"> Weeks.</p>
                ...
                <p><input type="radio" <?= checked(BMembershipLevel::MONTHS,$subscription_duration_type,false)?> value="<?= BMembershipLevel::MONTHS?>" name="subscription_duration_type" /> Expire After 
                    <input type="text" value="<?= checked(BMembershipLevel::MONTHS,$subscription_duration_type,false)? $subscription_period: "";?>" name="subscription_period_<?= BMembershipLevel::MONTHS?>"> Months.</p>
                ...
                <p><input type="radio" <?= checked(BMembershipLevel::YEARS,$subscription_duration_type,false)?> value="<?= BMembershipLevel::YEARS?> name="subscription_duration_type" /> Expire After 
                    <input type="text" value="<?= checked(BMembershipLevel::YEARS,$subscription_duration_type,false)? $subscription_period: "";?>" name="subscription_period_<?= BMembershipLevel::YEARS?>"> Years.</p>                
                
                <p><input type="radio" <?= checked(BMembershipLevel::FIXED_DATE,$subscription_duration_type,false)?> value="<?= BMembershipLevel::FIXED_DATE?>" name="subscription_duration_type" /> Expire After 
