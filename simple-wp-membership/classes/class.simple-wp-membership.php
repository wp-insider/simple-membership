...
class SimpleWpMembership {
    ...
    public function menu() {
        add_menu_page(__("WP Membership", 'swpm'), __("WP Membership", 'swpm'), 'manage_options', 'simple_wp_membership', array(&$this, "admin_members"), SIMPLE_WP_MEMBERSHIP_URL . '/images/logo.png');
        add_submenu_page('simple_wp_membership', __("Members", 'swpm'), __('Members', 'swpm'), 'manage_options', 'simple_wp_membership', array(&$this, "admin_members"));
        add_submenu_page('simple_wp_membership', __("Membership Levels", 'swpm'), __("Membership Levels", 'swpm'), 'manage_options', 'simple_wp_membership_levels', array(&$this, "admin_membership_levels"));
        add_submenu_page('simple_wp_membership', __("Settings", 'swpm'), __("Settings", 'swpm'), 'manage_options', 'simple_wp_membership_settings', array(&$this, "admin_settings"));
    ...
    public static function initdb() {
        ...
        if (empty($installed_version)) { // fresh install
            ...
            $reg_email_body = "Dear {first_name}\n\n" .
            ...
            $reg_prompt_email_body = "Dear {first_name}" .
            ...
            $upgrade_email_subject = "Member Account Upgraded";
            $upgrade_email_body = "Dear {first_name}" .
                    "\n\nYour account has been upgraded." .
                    "\n\nThank You";

            $reset_email_subject = get_bloginfo('name') . ": New Password";
            $reset_email_body = "Dear {first_name}" .
