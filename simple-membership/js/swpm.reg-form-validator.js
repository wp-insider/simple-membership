  ...
  const formData = {
    ...
    password: {
      ...
      rule: isStrongPasswordEnabled ? stringType({
        ...
        message: (_n = validationMsg == null ? void 0 : validationMsg.password) == null ? void 0 : _n.regex
      }).min(8, { message: (_o = validationMsg == null ? void 0 : validationMsg.password) == null ? void 0 : _o.minLength }).min(1, { message: (_p = validationMsg == null ? void 0 : validationMsg.password) == null ? void 0 : _p.required }) : stringType({
