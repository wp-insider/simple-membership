...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const membershipLevelSchema = z.object({
    // @ts-ignore
    alias: z.string().trim().min(1, (_a = validationMsg == null ? void 0 : validationMsg.membershipLevelAlias) == null ? void 0 : _a.required)
  });
  const form = document.getElementById(formID);
  form == null ? void 0 : form.addEventListener("submit", function(e) {
    e.preventDefault();
  ...
  function clearErrors(form2) {
    form2.querySelectorAll(".swpm-membership-level-field-error").forEach((el) => {
      el.remove();
    });
    form2.querySelectorAll("td.error").forEach((el) => {
  ...
  function showErrors(error) {
    error.errors.forEach((err, index) => {
      ...
      const errFieldCont = errField == null ? void 0 : errField.parentElement;
      ...
      errField == null ? void 0 : errField.addEventListener("change", function() {
        const currentForm = errField == null ? void 0 : errField.closest("form");
        if (currentForm) {
